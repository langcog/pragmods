...
```{r}
choice_correct_aggregated <- subset(choice_correct_aggregated, choice_correct_aggregated$Answer.scale_and_levels_condition == 6 | choice_correct_aggregated$Answer.scale_and_levels_condition == 8 |choice_correct_aggregated$Answer.scale_and_levels_condition == 9 | choice_correct_aggregated$Answer.scale_and_levels_condition == 11 | choice_correct_aggregated$Answer.scale_and_levels_condition == 12)
```
