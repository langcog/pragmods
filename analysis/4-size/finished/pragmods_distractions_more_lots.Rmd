...
```{r}
choice_correct_aggregated <- subset(choice_correct_aggregated, choice_correct_aggregated$Answer.scale_and_levels_condition == 4 | choice_correct_aggregated$Answer.scale_and_levels_condition == 11 |choice_correct_aggregated$Answer.scale_and_levels_condition == 12 | choice_correct_aggregated$Answer.scale_and_levels_condition == 19 |choice_correct_aggregated$Answer.scale_and_levels_condition == 20)
```
